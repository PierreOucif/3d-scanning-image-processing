    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If IO.File.Exists(Path) Then
            ...
            If Not (ImageAAnalyser Is Nothing) Then
                ...
                MsgBox("Temps nécessaire pour la méthode sélectionnée : " & elapsedTime)
                MsgBox("Le premier pixel à pour décomposition de couleurs : R " & ImageAAnalyser(0, 0).R & ", B : " & ImageAAnalyser(0, 0).B & " et V : " & ImageAAnalyser(0, 0).G)
